...
layui.use('table', function () {
    ...
    table.on('tool(table)', function (obj) {
        ...
        if (obj.event === 'detail') {
            ...
            window.location.href = '/WorkSheet/WorkSheetDetail.html?id=' + data.ID + "&sign=1";
        }
    });
});
...
function Page() {
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#table'
            , url: '/WorkSheet/MyAuditList?ahID=' + ahID + '&voltageType=' + voltageType + "&beginDate=" + beginDate + "&endDate=" + endDate + "&departmentID=" + departmentID + "&no=" + no
            , page: true
